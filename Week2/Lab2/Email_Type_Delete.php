    ...
    <body>
        <?php
            ...
            if(isset($TID))
            {
                ...
                {
                    Echo '<h1>Email Type Could not Be Deleted</h1><h3>You will be returned to the menu shortly, Click the button if nothing happens</h3><form method="link" action ="Email_Type_Test.php"><input type="submit" value="Return"/></form>';
